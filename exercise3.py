...
icon = pg.display.set_icon(pg.image.load(r"mickeyclock.png"))
clock = pg.time.Clock()

# loading the images 
bg_surf = pg.image.load(r"mickeyclock.png")
leftarm_surf = pg.image.load(r"left_hand.png")
rightarm_surf = pg.image.load(r"right_hand.png")
